...
Index: /livestreams. Playlists: /videos/playlist/live-contentstack, /videos/playlist/live-hygraph, /videos/playlist/live-uniform, /videos/playlist/misc-streams.`,
  ...
  },
  {
    path: '/projects',
    title: 'Projects',
    description: 'Agentlint, platform SDKs, MCP servers, local-first Mac apps, and weekend experiments.',
    prose: `Agentlint, platform SDKs, MCP servers, local-first Mac apps, and weekend experiments. Curated list at /projects.`,
  },
  {
    path: '/press-kit',
    title: 'Press kit',
  ...
  },
  {
    ...
    description:
      'How to reach Tim Benniks for speaking, podcast bookings, corrections, and collaboration, with contact details at /contact.',
    prose: `Tim Benniks welcomes speaking inquiries, podcast bookings, press questions, and corrections to published content.

LinkedIn: https://linkedin.com/in/timbenniks, contact Tim for booking conferences, podcasts, workshops, and panels. Include event name, proposed dates, format (keynote, talk, workshop, podcast), audience, and location.

Press and photos: /press-kit and /press-kit.json have bios, headshots, on-stage photos, and speaker topics.

Agent booking: call request_booking via /tools.json or /api/mcp. Returns a draft message for the user to confirm. Agents must not send messages without human approval.
...
Messages: if you contact Tim, your message and address are used only to respond. Messages are not sold or shared for advertising.
...
Your rights: EU/UK visitors may request access or deletion of personal data using the contact page. Tim Benniks aims to respond within 30 days.

Contact: /contact. Last updated August 2026.`,
  },
  {
    path: '/developers',
